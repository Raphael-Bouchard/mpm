...
namespace mpm {
    namespace geometry {
      ...
      Eigen::Matrix<double, Tdim, Tdim> rotation_matrix(
        ...
        //! \tparam Tdim Dimension
        template <int Tdim>
        double angle_between_vectors(const Eigen::Matrix<double, Tdim, 1>& vector_a, const Eigen::Matrix<double, Tdim, 1>& vector_b);
        ...
        //! \tparam Tdim Dimension
        template <int Tdim>
        Eigen::Matrix<double, Tdim, 1> euler_angles_cartesian(const Eigen::Matrix<double, Tdim, Tdim>& new_axes);
      }  // namespace geometry
}  // namespace mpm
