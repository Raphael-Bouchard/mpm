...
//! \retval p Mean stress p (tension positive)
 double p(const Eigen::Matrix<double, 6, 1>& stress);

//! Compute deviatoric stress
//! \param[in] stress Stress in Voigt notation where positive is tension
//! \retval deviatoric_stress Deviatoric stress
 const Eigen::Matrix<double, 6, 1> deviatoric_stress(
    const Eigen::Matrix<double, 6, 1>& stress);

//! Compute J2 invariant
//! \param[in] stress Stress in Voigt notation where positive is tension
//! \retval J2 invariant
 double j2(const Eigen::Matrix<double, 6, 1>& stress);

//! Compute J3 invariant
//! \param[in] stress Stress in Voigt notation where positive is tension
//! \retval J3 invariant
double j3(const Eigen::Matrix<double, 6, 1>& stress);

//! Compute deviatoric q
//! \param[in] stress Stress in Voigt notation where positive is tension
//! \retval q Deviatoric q
double q(const Eigen::Matrix<double, 6, 1>& stress);
...
double pdstrain(const Eigen::Matrix<double, 6, 1>& plastic_strain);
